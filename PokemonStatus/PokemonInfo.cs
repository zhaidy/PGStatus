...
namespace PokemonStatus
{
    ...
    public static class PokemonInfo
    {
        ...
        public static double CalculatePokemonPerfection2(PokemonData poke)
        {

            return (poke.IndividualAttack + poke.IndividualDefense + poke.IndividualStamina) / (3.0 * 15.0) * 100.0;
